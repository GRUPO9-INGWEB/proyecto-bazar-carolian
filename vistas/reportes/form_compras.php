<?php
// vistas/reportes/form_compras.php
// Variables: $fecha_desde, $fecha_hasta, $tipo_filtro, $tiposComprobante

$accionActual = $_GET['accion'] ?? 'compras';
?>
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        <h5 class="card-title mb-1">
            <i class="bi bi-cart-check me-1"></i> Reporte de compras
        </h5>
        <p class="card-text text-muted small mb-4">
            Genere un PDF con el resumen de compras realizadas por rango de fechas y
            tipo de comprobante. Útil para analizar el ingreso de mercadería.
        </p>

        <form method="post"
              action="panel_admin.php?modulo=reportes&accion=compras_pdf"
              target="_blank">
